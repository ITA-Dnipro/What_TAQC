...
{
    [AllureNUnit]
    internal class POST_CreateNewCourseSuccessTest : BaseTest
    {
       ...
       [SetUp]
        ...
        [AllureSuite("Courses")]
        [AllureSubSuite("POST")]
        [TestCase(Controller.UserRole.Admin, "test119", Description = "Send POST request to swagger and create new course as admin")]
        [TestCase(Controller.UserRole.Secretary, "s_test119", Description = "Send POST request to swagger and create new course as secretary")]
